<template>
  <div class="g-inherit m-article">
    <div class="Chat-nav">
      ...
      <span @click="enterNameCard">{{sessionName}}</span>
      <div>
        <span @click='onHistoryClick'>历史&nbsp;&nbsp;</span>
        <span v-if="scene==='team'"  @click="onTeamManageClick">成员</span>
      </div>
    </div>
...
export default {
  ...
  created(){
    ...
    let tID = this.$route.params.sessionId.replace(/^team-/, '')
    console.log(tID)
    this.teamID=tID;
  },
  computed: {
