<template>
  <div class="g-inherit m-main p-contacts">
    ...
    <div id="userList" class="m-list">
      <van-cell-group class="u-card" title="群">
        <van-cell title="高级群" is-link to='/teamlist/advanced'>
          <span class="icon icon-team-advanced" slot="icon"></span>
        </van-cell>
        <van-cell title="讨论组" is-link to='/teamlist/normal'>
          <span class="icon icon-team" slot="icon"></span>
        </van-cell>
      </van-cell-group>
      <van-cell-group class="u-card" title="好友列表">
        <van-cell v-for="friend in friendslist" :title="friend.alias" :key="friend.account" is-link :to="friend.link">
      ...
      <van-cell-group class="u-card" title="机器人">
        <van-cell v-for="robot in robotslist" :title="robot.nick" :key="robot.account" is-link :to="robot.link">
          <img class="icon u-circle" slot="icon" width="20" :src="robot.avatar">
        </van-cell>
      </van-cell-group>
      <van-cell-group class="u-card" title="黑名单">
        <van-cell v-for="friend in blacklist" :title="friend.alias" :key="friend.account" is-link :to="friend.link">
